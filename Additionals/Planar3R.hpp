...
namespace IRlibrary {
	class Planar3R {
		...
		public:
			...
			void setX(const Vec3 &x_i) {x = x_i; Vec3 init_thetalist = x_i; init_thetalist[0] -= M_PI/180.; init_thetalist[1] -= M_PI/180.; init_thetalist[2] -= M_PI/180.;
                        inverseKinematics_numerical(init_thetalist,x_i);}
